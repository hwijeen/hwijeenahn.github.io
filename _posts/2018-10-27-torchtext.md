...
<style type="text/css">
 ...
 font-weight: normal;
 font-style: normal;
 src: local('"Hack"'), url('fonts/Hack-Italic.ttf') format('truetype');
}
@font-face {
 font-family: "Hack";
 font-weight: normal;
 font-style: normal;
 src: local('"Hack"'), url('fonts/hack.ttf') format('truetype');
}
@font-face {
 font-family: "Hack";
 font-weight: normal;
 font-style: normal;
 src: local('"Hack"'), url('fonts/hack.woff2') format('woff2');
}
@font-face {
 font-family: "Hack";
 font-weight: normal;
 font-style: italic;
 src: local('"Hack"'), url('fonts/hack-italic.woff2') format('woff2');
}
div#notebook {
 font-family: sans-serif;
 font-size: 11pt;
...
<h1 id="torchtext&#47484;-&#51060;&#50857;&#54620;-&#53581;&#49828;&#53944;-&#51204;&#52376;&#47532;-&#44284;&#51221;">torchtext&#47484; &#51060;&#50857;&#54620; &#53581;&#49828;&#53944; &#51204;&#52376;&#47532; &#44284;&#51221;<a class="anchor-link" href="#torchtext&#47484;-&#51060;&#50857;&#54620;-&#53581;&#49828;&#53944;-&#51204;&#52376;&#47532;-&#44284;&#51221;">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>자연어처리 어떤 태스크든, 전처리 과정은 필수다. Train, valid, test set 나누기, 특정 형태의 data를 파일에서 읽어오기, tokenizing, vocab만들기, data를 raw sentence에서 vocab index로 바꾸기, pretrained word embedding 불러오기, batch 단위 data iterator만들기. 이 모든 과정을 편리하게 해주는 torchtext에 대한 정리. <a href="http://anie.me/On-Torchtext/">외국 블로그</a>글, torchtext 소스코드를 보고 정리했다.</p>
...
<span class="kn">import</span> <span class="nn">spacy</span> <span class="c1"># for tokenizer</span>
<span class="kn">from</span> <span class="nn">torchtext</span> <span class="k">import</span> <span class="n">data</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="1.-Tokenizer">1. Tokenizer<a class="anchor-link" href="#1.-Tokenizer">&#182;</a></h2>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">spacy_en</span> <span class="o">=</span> <span class="n">spacy</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s1">&#39;en&#39;</span><span class="p">)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="s1">&#39;===== spacy tokenizer 예시. 예상과 다른 것들도 있으니까 유의하자. =====&#39;</span><span class="p">)</span>
<span class="n">s1</span> <span class="o">=</span> <span class="s1">&#39;Just a normal sentence.&#39;</span>
<span class="n">s2</span> <span class="o">=</span> <span class="s1">&#39;A sentence with 1, 2 and 3(numbers)&#39;</span>
<span class="n">s3</span> <span class="o">=</span> <span class="s1">&#39;email address: hwijeen@hwii.com&#39;</span>
<span class="n">s4</span> <span class="o">=</span> <span class="s1">&#39;nice to meetya ^^! bye~~.&#39;</span>
<span class="n">sentences</span> <span class="o">=</span> <span class="p">[</span><span class="n">s1</span><span class="p">,</span> <span class="n">s2</span><span class="p">,</span> <span class="n">s3</span><span class="p">,</span> <span class="n">s4</span><span class="p">]</span>
<span class="k">for</span> <span class="n">s</span> <span class="ow">in</span> <span class="n">sentences</span><span class="p">:</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">tokenizer</span><span class="p">(</span><span class="n">s</span><span class="p">))</span>
</pre></div>
...
<pre>===== spacy tokenizer 예시. 예상과 다른 것들도 있으니까 유의하자. =====
[&#39;Just&#39;, &#39;a&#39;, &#39;normal&#39;, &#39;sentence&#39;, &#39;.&#39;]
[&#39;A&#39;, &#39;sentence&#39;, &#39;with&#39;, &#39;1&#39;, &#39;,&#39;, &#39;2&#39;, &#39;and&#39;, &#39;3(numbers&#39;, &#39;)&#39;]
[&#39;email&#39;, &#39;address&#39;, &#39;:&#39;, &#39;hwijeen@hwii.com&#39;]
[&#39;nice&#39;, &#39;to&#39;, &#39;meetya&#39;, &#39;^^&#39;, &#39;!&#39;, &#39;bye~~.&#39;]
</pre>
</div>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="2.-torchtext.data.Field">2. torchtext.data.Field<a class="anchor-link" href="#2.-torchtext.data.Field">&#182;</a></h2>
</div>
</div>
</div>torchtext는 데이터가 하나의 파일에 있다고 가정한다. torchtext를 사용해 기계번역 데이터 전처리를 할 경우, 하나의 파일 안에 src sentence와 tgt sentence가 구분자(',', '\t' 등)으로 구분되어 있어야한다. 이때, 구분자로 나눠지는 각각의 column을 Field라고 부른다. 데이터마다 Field의 특성(숫자냐 문장이냐 등)이 다른데, Field instance를 만들면서 그 정보를 넣어준다.
<div class="cell border-box-sizing code_cell rendered">
<div class="input">
<div class="prompt input_prompt">In&nbsp;[104]:</div>
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">SRC</span> <span class="o">=</span> <span class="n">data</span><span class="o">.</span><span class="n">ReversibleField</span><span class="p">(</span><span class="n">sequential</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">tokenize</span><span class="o">=</span><span class="n">tokenizer</span><span class="p">,</span> <span class="n">lower</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">eos_token</span><span class="o">=</span><span class="s1">&#39;&lt;eos&gt;&#39;</span><span class="p">,</span>
                 <span class="n">batch_first</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="n">TGT</span> <span class="o">=</span> <span class="n">data</span><span class="o">.</span><span class="n">ReversibleField</span><span class="p">(</span><span class="n">sequential</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">tokenize</span><span class="o">=</span><span class="n">tokenizer</span><span class="p">,</span> <span class="n">lower</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">eos_token</span><span class="o">=</span><span class="s1">&#39;&lt;eos&gt;&#39;</span><span class="p">,</span>
                <span class="n">batch_first</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="c1"># ReversibleField</span>
<span class="c1"># pytorch에서 rnn_packed_padded_sequence()를 쓰려면 include_length=True 필요</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="s1">&#39;===== (Reversible)Field의 namespace: =====&#39;</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">SRC</span><span class="o">.</span><span class="vm">__dict__</span><span class="p">)</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>===== (Reversible)Field의 namespace: =====
{&#39;use_revtok&#39;: True, &#39;sequential&#39;: True, &#39;use_vocab&#39;: True, &#39;init_token&#39;: None, &#39;eos_token&#39;: &#39;&lt;eos&gt;&#39;, &#39;unk_token&#39;: &#39; UNK &#39;, &#39;fix_length&#39;: None, &#39;dtype&#39;: torch.int64, &#39;preprocessing&#39;: None, &#39;postprocessing&#39;: None, &#39;lower&#39;: True, &#39;tokenize&#39;: &lt;function tokenizer at 0x7f24f1f4cc80&gt;, &#39;include_lengths&#39;: False, &#39;batch_first&#39;: True, &#39;pad_token&#39;: &#39;&lt;pad&gt;&#39;, &#39;pad_first&#39;: False, &#39;truncate_first&#39;: False, &#39;stop_words&#39;: None, &#39;is_target&#39;: False}
</pre>
</div>
</div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>preprocessing, postprocessing?</li>
</ul>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="3.-torchtext.data.Dataset">3. torchtext.data.Dataset<a class="anchor-link" href="#3.-torchtext.data.Dataset">&#182;</a></h2>
</div>
</div>
</div>Dataset은 데이터 전체에 대한 클래스로, Field 정보를 알아야지만 만들 수 있다.torchtext.dataset에는 자주 쓰이는 public 데이터를 다운 받아서 tochtext.data.Dataset으로 만들어주는 클래스가 있다. 로컬에 있는 파일을 사용하려면 torchtext.data.TabularDataset을 이용한다. TabularDataset을 train, valid, test로 나누는 건 Dataset.split() 메서드를 이용한다. 만약 로컬에 있는 파일이 이미 split된 상태라면, TabularDataset.splits()라는 class method를 통해 각각 읽어올 수 있다.
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">corpus</span> <span class="o">=</span> <span class="n">data</span><span class="o">.</span><span class="n">TabularDataset</span><span class="p">(</span><span class="n">path</span><span class="o">=</span><span class="s1">&#39;./data/en-fr.toy.txt&#39;</span><span class="p">,</span> <span class="nb">format</span><span class="o">=</span><span class="s1">&#39;tsv&#39;</span><span class="p">,</span>
                            <span class="n">fields</span><span class="o">=</span><span class="p">[(</span><span class="s1">&#39;src&#39;</span><span class="p">,</span><span class="n">SRC</span><span class="p">),</span> <span class="p">(</span><span class="s1">&#39;tgt&#39;</span><span class="p">,</span><span class="n">TGT</span><span class="p">)])</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="s1">&#39;===== TabularDataset의 namespace: =====</span><span class="se">\n</span><span class="s1">&#39;</span><span class="p">,</span> <span class="n">corpus</span><span class="o">.</span><span class="vm">__dict__</span><span class="o">.</span><span class="n">keys</span><span class="p">())</span>
<span class="nb">print</span><span class="p">(</span><span class="s1">&#39;</span><span class="se">\n</span><span class="s1">===== Example의 namespace: =====&#39;</span><span class="p">);</span> <span class="n">pprint</span><span class="p">(</span><span class="n">corpus</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="vm">__dict__</span><span class="p">)</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>===== TabularDataset의 namespace: =====
 dict_keys([&#39;examples&#39;, &#39;fields&#39;])

===== Example의 namespace: =====
{&#39;src&#39;: [&#39;resumption&#39;, &#39;of&#39;, &#39;the&#39;, &#39;session&#39;],
 &#39;tgt&#39;: [&#39;reprise&#39;, &#39;de&#39;, &#39;la&#39;, &#39;session&#39;]}
</pre>
</div>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="4.-torchtext.data.Field.build_vocab()">4. torchtext.data.Field.build_vocab()<a class="anchor-link" href="#4.-torchtext.data.Field.build_vocab()">&#182;</a></h2>
</div>
</div>
</div>vocab은 Field의 instance이다. 데이터에 대한 vocab이 아니라 Field마다 vocab이 있음에 주의! build_vocab()의 인자로 Dataset을 넣어준다. 만약 pretrained vector을 안 쓸 거라면 train 데이터만 넣어주는 것이 맞다. 하지만 pretrained vector을 쓸 거라면 train, valid, test 데이터 모두 넣어줘야한다. 
<div class="cell border-box-sizing code_cell rendered">
<div class="input">
<div class="prompt input_prompt">In&nbsp;[108]:</div>
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">SRC</span><span class="o">.</span><span class="n">build_vocab</span><span class="p">(</span><span class="n">train</span><span class="o">.</span><span class="n">src</span><span class="p">)</span> <span class="c1"># vectors=&#39;glove.6B.100d&#39; 인자 추가시 자동 다운로드</span>
<span class="n">TGT</span><span class="o">.</span><span class="n">build_vocab</span><span class="p">(</span><span class="n">train</span><span class="o">.</span><span class="n">tgt</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="s1">&#39;===== Field의 namespace에 vocab이 추가되었다 =====&#39;</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">SRC</span><span class="o">.</span><span class="vm">__dict__</span><span class="p">)</span>

<span class="nb">print</span><span class="p">(</span><span class="s1">&#39;</span><span class="se">\n</span><span class="s1">===== vocab의 namespace =====&#39;</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">SRC</span><span class="o">.</span><span class="n">vocab</span><span class="o">.</span><span class="vm">__dict__</span><span class="o">.</span><span class="n">keys</span><span class="p">())</span> <span class="c1"># itos is a list</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>===== Field의 namespace에 vocab이 추가되었다 =====
{&#39;use_revtok&#39;: True, &#39;sequential&#39;: True, &#39;use_vocab&#39;: True, &#39;init_token&#39;: None, &#39;eos_token&#39;: &#39;&lt;eos&gt;&#39;, &#39;unk_token&#39;: &#39; UNK &#39;, &#39;fix_length&#39;: None, &#39;dtype&#39;: torch.int64, &#39;preprocessing&#39;: None, &#39;postprocessing&#39;: None, &#39;lower&#39;: True, &#39;tokenize&#39;: &lt;function tokenizer at 0x7f24f1f4cc80&gt;, &#39;include_lengths&#39;: False, &#39;batch_first&#39;: True, &#39;pad_token&#39;: &#39;&lt;pad&gt;&#39;, &#39;pad_first&#39;: False, &#39;truncate_first&#39;: False, &#39;stop_words&#39;: None, &#39;is_target&#39;: False, &#39;vocab&#39;: &lt;torchtext.vocab.Vocab object at 0x7f24ef975be0&gt;}
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="5.-torchtext.data.Iterator">5. torchtext.data.Iterator<a class="anchor-link" href="#5.-torchtext.data.Iterator">&#182;</a></h2>
</div>
</div>
</div>batch size만큼 데이터를 뱉어줄 iterator를 만든다. Dataset에 들어있는 Examples에는 raw input string이 담겨있다. Iterator는 이를 index로 바꿔서, torch.Tensor로 내뱉는다. 'train'안의 'Field'안에 vocab이 담겨 있으니까 indexing 작업을 할 수 있다!
<div class="cell border-box-sizing code_cell rendered">
<div class="input">
<div class="prompt input_prompt">In&nbsp;[110]:</div>
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">train_iter</span><span class="p">,</span> <span class="n">valid_iter</span><span class="p">,</span> <span class="n">test_iter</span> <span class="o">=</span> <span class="n">data</span><span class="o">.</span><span class="n">Iterator</span><span class="o">.</span><span class="n">splits</span><span class="p">((</span><span class="n">train</span><span class="p">,</span><span class="n">val</span><span class="p">,</span><span class="n">test</span><span class="p">),</span>
...
<span class="c1"># sort_within_batch = True 해야 rnn_pack_padded_sequence 쓸 수 있음!</span>
<span class="c1"># repeat=False 시 1 epoch 돌고 iter 끝남</span>
<span class="c1"># None 시 train은 계속 돌고 val, test iter은 한 번 돈다</span>
</pre></div>
...
</div>모델 훈련 부분의 코드는 이렇게 구성할 수 있다. Iterator에서 repeat=False를 해줬기에 다음과 같이 epoch에 대한 for문을 사용할 수 있다.
<div class="cell border-box-sizing code_cell rendered">
<div class="input">
<div class="prompt input_prompt">In&nbsp;[111]:</div>
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">EPOCH</span> <span class="o">=</span> <span class="mi">100</span>
<span class="k">for</span> <span class="n">epoch</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">EPOCH</span><span class="p">):</span> <span class="c1"># repeat=False 필요</span>
    <span class="k">for</span> <span class="n">train_batch</span> <span class="ow">in</span> <span class="n">train_iter</span><span class="p">:</span>
        ...
        <span class="k">pass</span> <span class="c1"># train for one epoch</span>
    <span class="k">for</span> <span class="n">valid_batch</span> <span class="ow">in</span> <span class="n">valid_iter</span><span class="p">:</span>
        <span class="k">pass</span> <span class="c1"># record valid performance</span>
</pre></div>
...
<div class="text_cell_render border-box-sizing rendered_html">
<ul>
<li>valid, test 할 때 batch size?</li>
</ul>
